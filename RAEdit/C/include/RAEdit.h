...
typedef struct {
DWORD hFont; //Code edit normal
DWORD hIFont; //Code edit italics
DWORD hLnrFont; //Line numbers
} RAFONT;

typedef struct {
DWORD bckcol; //Back color
DWORD txtcol; //Text color
DWORD selbckcol; //Sel back color
DWORD seltxtcol; //Sel text color
DWORD cmntcol; //Comment color
DWORD strcol; //String color
DWORD oprcol; //Operator color
DWORD hicol1; //Line hilite 1
DWORD hicol2; //Line hilite 2
DWORD hicol3; //Line hilite 3
DWORD selbarbck; //Selection bar
DWORD selbarpen; //Selection bar pen
DWORD lnrcol; //Line numbers color
DWORD numcol; //Numbers & hex color
DWORD cmntback; //Comment back color
DWORD strback; //String back color
DWORD numback; //Numbers & hex back color
DWORD oprback; //Operator back color
DWORD changed; //Line DWORD indicator
DWORD changesaved; //Line saved chane indicator
} RACOLOR;
...
#define BD_ALTHILITE 0x80 //ADWORDs 1 to the current word group for syntax coloring.

typedef struct {
DWORD lpszStart; //Block start
DWORD lpszEnd; //Block end
DWORD lpszNot1; //Dont hide line containing this or set to NULL
DWORD lpszNot2; //Dont hide line containing this or set to NULL
...
//szRAEditClass BYTE 'RAEdit',0
//szEditClassName BYTE 'RAEditChild',0
